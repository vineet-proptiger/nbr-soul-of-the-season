      ...
      <div className="hero-content">
        <>
            ...
            <p className="hero-subtitle" data-aos="fade-right" data-aos-delay="100">
              <span style={{ fontSize: '0.85em', fontWeight: 500, textTransform: 'none' }}>AT SARJAPUR ROAD, GUNJUR, BANGALORE</span>
            </p>
            {/* Bullet Points */}
            <div className="hero-bullets" style={{ marginBottom: '24px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
              {[
                "88% open spaces based on GAIA philosophy of five natural elements",
                "Select 3 BHK units feature unique triple height balconies",
                "Features over 70 world-class amenities for wellness & recreation",
                "40,000 sq ft central clubhouse named The Season's Heart"
              ].map((text, i) => (
            ...
            <div className="hero-cta-row" style={{ marginTop: '16px' }}>
              ...
              <div data-aos="flip-up" data-aos-delay="1400">
                ...
                >
                  Price starts <span className="hero-price-amt" style={{ fontSize: '15px', marginLeft: '6px' }}>₹ 1.75 Cr Onwards</span>
                </div>
              </div>
