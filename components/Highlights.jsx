...
const highlights = [
  ...
  { title: 'PRIME SARJAPUR LOCATION', desc: 'Strategically located in Gunjur, Sarjapur Road with seamless city connectivity.', Icon: IconMapPin },
]
    ...
    <div className="px-4 sm:px-8" style={{ maxWidth: '1100px', margin: '0 auto' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '40px' }}>
        <h2 data-aos="flip-left" data-aos-delay="300" style={{
          ...
          Designed for Comfort, Wellness &amp; Leisure At NBR Soul of The Season
        </h2>
      </div>
